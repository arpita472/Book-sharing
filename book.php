...
function book_sharing_enqueue_assets() {
    wp_enqueue_style('book-sharing-css', plugin_dir_url(__FILE__) . 'book-sharing.css');
    wp_enqueue_script('book-sharing-js', plugin_dir_url(__FILE__) . 'book-sharing.js', array('jquery'), null, true);
}
...
register_activation_hook(__FILE__, 'book_sharing_activate');
...
register_uninstall_hook(__FILE__, 'book_sharing_uninstall');
